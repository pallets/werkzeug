...
_TAnyAccept = TypeVar("_TAnyAccept", bound="Accept")
...
class Accept(ImmutableList[Tuple[str, int]]):
    ...
    def parse_header(
        ...
        _TAnyAccept, "Accept", "MIMEAccept", "CharsetAccept", "LanguageAccept"
    ]: ...
...
class MIMEAccept(Accept):
    ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> "MIMEAccept": ...
...
class LanguageAccept(Accept):
    ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> "LanguageAccept": ...

class CharsetAccept(Accept):
    def _value_matches(self, value: str, item: str) -> bool: ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> "CharsetAccept": ...

_CPT = TypeVar("_CPT", str, int, bool)
_OptCPT = Optional[_CPT]
_TAnyCC = TypeVar("_TAnyCC", bound="_CacheControl")
_t_cc_update = Optional[Callable[[_TAnyCC], None]]
...
class _CacheControl(UpdateDictMixin[str, _OptCPT], Dict[str, _OptCPT]):
    ...
    @classmethod
    def parse_header(
        cls, value: Optional[str], on_update: _t_cc_update
    ) -> Union["RequestCacheControl", "ResponseCacheControl", _TAnyCC]: ...
    @staticmethod
...
class ETags(Collection[str]):
    ...
    def to_header(self) -> str: ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> "ETags": ...
    def __call__(
        self,
...
class IfRange:
    ...
    def to_header(self) -> str: ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> "IfRange": ...
...
class Range:
    ...
    def to_header(self) -> str: ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> Optional["Range"]: ...
...
class Authorization(ImmutableDictMixin[str, str], Dict[str, str]):
    ...
    def to_header(self) -> str: ...
    @classmethod
    def parse_header(cls, value: Optional[str]) -> Optional["Authorization"]: ...
