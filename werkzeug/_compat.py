...
iterkeys = lambda d, *a, **kw: iter(getattr(d, six._iterkeys)(*a, **kw))
itervalues = lambda d, *a, **kw: iter(getattr(d, six._itervalues)(*a, **kw))
iteritems = lambda d, *a, **kw: iter(getattr(d, six._iteritems)(*a, **kw))
