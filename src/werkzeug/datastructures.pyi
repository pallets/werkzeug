...
class _CacheControl(UpdateDictMixin[str, _OptCPT], Dict[str, _OptCPT]):
    ...
    def to_header(self) -> str: ...
    @classmethod
    def parse_header(cls, value: Optional[str], on_update: _t_cc_update) -> Union["RequestCacheControl", "ResponseCacheControl", _TAnyCC]: ...
    @staticmethod
...
class RequestCacheControl(ImmutableDictMixin[str, _OptCPT], _CacheControl):
    @classmethod
    def parse_header(cls, value: Optional[str], on_update: _t_cc_update) -> "RequestCacheControl": ...
    @property
...
class ResponseCacheControl(_CacheControl):
    @classmethod
    def parse_header(cls, value: Optional[str], on_update: _t_cc_update) -> "ResponseCacheControl": ...
    @property
